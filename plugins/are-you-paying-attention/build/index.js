...
wp.blocks.registerBlockType("ourplugin/are-paying-attention", {
  ...
  // The title of the block shown in the Gutenberg block selector.
  icon: "smiley",
  // The block icon displayed in the block selector (WordPress Dashicons).
  category: "common",
  // Defines the block category where it will be listed in the Gutenberg editor.
