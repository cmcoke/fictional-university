...
/**
 * Summary:
 * This plugin adds a Word Count and Read Time feature to WordPress posts. It allows users to display 
 * post statistics such as word count, character count, and estimated reading time. These settings can be 
 * customized through the WordPress admin dashboard. The plugin also supports internationalization (i18n) 
...
class WordCountAndTimePlugin
{
  ...
  // Function to sanitize the input for display location
