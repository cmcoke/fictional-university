...
// Display a page banner with the archive title and description
pageBanner(array(
  'title' => get_the_archive_title(), // Get and display the archive title
  'subtitle' => get_the_archive_description() // Get and display the archive description
));
?>
