  ...
  async deleteLike(currentLikeBox) {
    try {
      ...
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default()({
        ...
        } // Send the ID of the like to delete
      });
...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(universityData.root_url + "/wp-json/university/v1/search?term=" + this.searchField.value); // Fetch results from the API.
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Search); // Export the Search class for use in other files.
