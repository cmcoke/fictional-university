...
/**
 * This code extends the WordPress REST API by adding a custom field called authorName to the post post type.
 * 
 * The custom field provides the name of the author of a post. When the REST API is initialized, this new field is registered, and it returns the author's name using the get_the_author() function.
 * 
 * This allows the author's name to be included in the REST API response for any post.
 */


// Function to add a custom field to the REST API response
function university_custom_rest()
{
  // Register a custom field 'authorName' for the 'post' post type in the REST API response
  register_rest_field('post', 'authorName', array(
    // Define the callback function that returns the author's name when the custom field is requested
    'get_callback' => function () {
      return get_the_author(); // Returns the name of the post's author
    }
  ));
}

// Hook the 'university_custom_rest' function to the 'rest_api_init' action to register the custom REST API field during REST API initialization
...
function university_files()
{
  ...
  // Pass PHP data to the main JavaScript file, making the WordPress site's root URL available via the universityData.root_url variable
