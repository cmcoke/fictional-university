...
/**
 * Registers custom Gutenberg blocks and localizes theme path data.
 */

function our_new_blocks()
{

  // Localizes data for JavaScript, allowing access to the theme path URL in 'wp-editor'
  wp_localize_script('wp-editor', 'ourThemeData', array('themePath' => get_stylesheet_directory_uri()));

  // Registers each custom block type in the theme from the respective metadata.json files
  register_block_type_from_metadata(__DIR__ . '/build/genericheading');   // Generic heading block
  register_block_type_from_metadata(__DIR__ . '/build/genericbutton');    // Generic button block
  register_block_type_from_metadata(__DIR__ . '/build/slideshow');        // Slideshow block
  register_block_type_from_metadata(__DIR__ . '/build/slide');            // Slide block
  register_block_type_from_metadata(__DIR__ . '/build/banner');           // Banner block
  register_block_type_from_metadata(__DIR__ . '/build/footer');           // Footer block
  register_block_type_from_metadata(__DIR__ . '/build/header');           // Header block
  register_block_type_from_metadata(__DIR__ . '/build/eventsandblogs');   // Events and blogs block
  register_block_type_from_metadata(__DIR__ . '/build/singlepost');       // Single post block
  register_block_type_from_metadata(__DIR__ . '/build/page');             // Page block
  register_block_type_from_metadata(__DIR__ . '/build/blogindex');        // Blog index block
  register_block_type_from_metadata(__DIR__ . '/build/programarchive');   // Program archive block
  register_block_type_from_metadata(__DIR__ . '/build/singleprogram');    // Single program block
  register_block_type_from_metadata(__DIR__ . '/build/singleprofessor');  // Single professor block
  register_block_type_from_metadata(__DIR__ . '/build/mynotes');          // My notes block
  register_block_type_from_metadata(__DIR__ . '/build/archivecampus');    // Campus archive block
  register_block_type_from_metadata(__DIR__ . '/build/archiveevent');     // Event archive block
  register_block_type_from_metadata(__DIR__ . '/build/archive');          // General archive block
  register_block_type_from_metadata(__DIR__ . '/build/pastevents');       // Past events block
  register_block_type_from_metadata(__DIR__ . '/build/singlecampus');     // Single campus block
  register_block_type_from_metadata(__DIR__ . '/build/singleevent');      // Single event block
  register_block_type_from_metadata(__DIR__ . '/build/search');           // Search block
  register_block_type_from_metadata(__DIR__ . '/build/searchresults');    // Search results block
}

// Hooks the function into the 'init' action, so the blocks are registered when WordPress initializes
